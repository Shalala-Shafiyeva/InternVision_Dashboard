  ...
  return (
    <div className={`${styles.sidebar} fixed`}>
      <div className="h-screen space-x-6">
        ...
        <div className="flex flex-col items-center w-60 h-full overflow-hidden text-gray-400 pt-5 rounded">
    ...
    ${isActive ? "bg-gray-700 text-gray-300" : ""}`
          ...
          <NavLink
            className="flex items-center justify-center w-full h-16 mt-auto  bg-gray-300 hover:bg-gray-700 text-gray-500 hover:text-gray-300 transition duration-150 ease-in-out"
            to="#"
          >
